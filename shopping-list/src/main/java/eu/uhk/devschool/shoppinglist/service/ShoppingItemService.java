...
public interface ShoppingItemService {
    ...
    /**
     * Method loads all available
     * {@link eu.uhk.devschool.shoppinglist.dto.ShoppingItem} records.
     */
    List<ShoppingItem> getAllItems();

    /**
     * Method loads all available
     * {@link eu.uhk.devschool.shoppinglist.dto.ShoppingItem} records by specific
     * category.
     */
    List<ShoppingItem> getItemsByCategory(ShoppingItemCategory category);

    /**
     * Creates a new {@link eu.uhk.devschool.shoppinglist.dto.ShoppingItem} record
     * for a Shopping List.
     */
    ...
    ShoppingItem getShoppingItem(Long id);
}
